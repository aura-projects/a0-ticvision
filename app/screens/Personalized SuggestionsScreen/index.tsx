...
import { useSuggestionStore } from "@/lib/SuggestionStore"
      ...
      interface Personalized SuggestionsScreenProps extends AppStackScreenProps<"Personalized Suggestions"> {}
      
      export const Personalized SuggestionsScreen = function Personalized SuggestionsScreen({
        navigation,
      }: Personalized SuggestionsScreenProps) {
          ...
          >
            ...
            {isLoading ? (
              ...
              <View className="flex-1">
                <Text>Screen content for Personalized Suggestions</Text>
              </View>
            )}
          </Screen>
        )
